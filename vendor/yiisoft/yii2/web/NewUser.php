 ...
 * @since 2.0
 */
class NewUser extends Component  //Zmieniłem na NewUser M.Kurant bo wywalało błąd
{
    ...
    public function init()
    {
        ...
        if ($this->identityClass === null) {
            throw new InvalidConfigException('NewUser::identityClass must be set.');    //M.Kurant zmieniłem na NewUser
        }
        if ($this->enableAutoLogin && !isset($this->identityCookie['name'])) {
            throw new InvalidConfigException('NewUser::identityCookie must contain the "name" element.');    //M.Kurant zmieniłem na NewUser
