...
/*
  Formularz dodawania nowych użytkowników z podziałem na rangi.
 * 30 administrator
 * 20 lekarz
 * 15 operator
 * 10 pacjent (on do panelu wstępu nie ma)
 * 
 * Jeśli po wysłaniu formularza są ustawione odpowiednie zmienne to wtedy wykonuje polecenie SQL.
 * Operator i lekarz nie mogą nadawać nowym użytkownikom rangi (roli) innej niż 10.
 * M.Kurant
 *  */
...
// Hasło, AccessToken i AuthKey są dopasowane do Yii2 podobnie łączenie z bazą dlatego konta użytkowników utworzone w yii2 albo tutaj są zgodne.
...
//wersja dla operatora i lekarza
elseif (isset($_SESSION['role']) && ($_SESSION['role'] === '20' || $_SESSION['role'] === '15')) {
    ...
    //proste zabezpieczenie przed dostępem osób niepowołanych
